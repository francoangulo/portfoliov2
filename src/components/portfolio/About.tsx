        ...
        <Stack flexDir={{ base: "column", lg: "row" }} minH={"100%"}>
          ...
          >
            <Text
              ...
              textAlign={"start"}
            >
              My name is Franco and I am a <b>Fullstack Web Developer</b>.
              Although I enjoy working on both sides, <b>Frontend</b> and{" "}
              <b>Backend</b>, I feel a bit more comfortable on the{" "}
              <b>Frontend</b> side. I am fascinated by the world of programming,
              I am a proactive person who is always looking to learn and grow,
              both professionally and personally. I feel identified with a
              phrase that I read and share:{" "}
              <i>"Nothing in the world can take the place of perseverance."</i>
              <br />I characterize myself for always being responsible, well
              predisposed and committed to my tasks, and easy to adapt to new
              work teams.
              <br />
              Check my Resume to know my experience!
            </Text>
            <Stack
              flexDir={"row"}
              w={{ base: "100%", lg: "70%" }}
